...
public class SystemMetadataDaoMetacatImplTestUtil {
    ...
    public static void populateSystemMetadata(JdbcTemplate jdbc, String sysMetaTable) {
        ...
        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('891f20463b023bef25758cabee18b460.1.1', NULL, '1', '2013-08-01 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'c3450ab5803151f78e9e8f91f30f285a', 'MD5', '', '', '2013-08-01 10:17:42.117', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.1.0', '7482', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('6f632bd1cc2772bdcc43bafdbb9d8669.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', '709eee7f02ff1f12a9084b906ee0770e', 'MD5', '', '', '2013-07-31 15:29:44.429', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14230', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('261585355b62129e038fabdacc1cd9fa.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eb0b66914142de3e6b2ed949f87096de', 'MD5', '', '', '2013-07-31 15:29:46.774', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14472', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco3-e2fab857d20b994edb1ad65069407423.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', '14b343527abc4892fb3b7e50b0b4b096', 'MD5', '', '', '2013-07-31 17:39:09.264', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14514', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco3-f6fcf091959497c2a77967b732d0e631.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'de2c9e3c4a700e3816d4140b8319cce0', 'MD5', '', '', '2013-07-31 17:39:11.085', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '13424', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco-test-6f632bd1cc2772bdcc43bafdbb9d8669.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', '709eee7f02ff1f12a9084b906ee0770e', 'MD5', '', '', '2013-07-31 17:41:34.387', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14230', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco-test-261585355b62129e038fabdacc1cd9fa.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eb0b66914142de3e6b2ed949f87096de', 'MD5', '', '', '2013-07-31 17:41:36.253', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14472', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco-test-e2fab857d20b994edb1ad65069407423.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', '14b343527abc4892fb3b7e50b0b4b096', 'MD5', '', '', '2013-07-31 17:41:38.243', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '14514', false, false, -1, NULL, NULL);";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco-test-f6fcf091959497c2a77967b732d0e631.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'de2c9e3c4a700e3816d4140b8319cce0', 'MD5', '', '', '2013-07-31 17:41:40.2', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '13424', false, false, -1, NULL, NULL);  ";
        jdbc.execute(str);

        str = "INSERT INTO "
                + sysMetaTable
                + " VALUES ('pisco-test-774d0eb40bb051046a5469be7d912d30.1.1', NULL, '1', '2013-07-31 17:00:00', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', '1842c6ce6c398afe62f15a01063b39a9', 'MD5', '', '', '2013-07-31 17:41:42.331', 'uid=cjones,o=NCEAS,dc=ecoinformatics,dc=org', 'eml://ecoinformatics.org/eml-2.0.1', '17211', false, false, -1, NULL, NULL);";
        jdbc.execute(str);
    }
